define(['angular', 'css!./user.css'], function(angular) {
    ...
    deliveryController.$inject = ['$scope', '$state', '$stateParams', '$address', '$verifyService', '$homeService', '$timeout', '$http', 'userInfo', '$common'];

    function deliveryController($scope, $state, $stateParams, $address, $verifyService, $homeService, $timeout, $http, userInfo, $common) {
        var vm = this;
    ...
    //查询地址
    addController.$inject = ['$address', '$scope', '$state', '$stateParams', '$q', '$verifyService', '$rootScope', '$timeout', '$http', '$userService', '$common', 'userInfo'];

    function addController($address, $scope, $state, $stateParams, $q, $verifyService, $rootScope, $timeout, $http, $userService, $common, userInfo) {
        var vm = this;
        vm.name = '';
        vm.phone = '';
        vm.eml = '';
